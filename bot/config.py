...
EGRESS_DENYLIST_DOMAINS = _env_with_runtime_default('EGRESS_DENYLIST_DOMAINS', DEFAULT_ENV['EGRESS_DENYLIST_DOMAINS'])
EGRESS_DENYLIST_CIDRS = _env_with_runtime_default('EGRESS_DENYLIST_CIDRS', DEFAULT_ENV['EGRESS_DENYLIST_CIDRS'])
EGRESS_DENYLIST_REFRESH_MINUTES = env_int('EGRESS_DENYLIST_REFRESH_MINUTES', int(DEFAULT_ENV['EGRESS_DENYLIST_REFRESH_MINUTES']))
EGRESS_DENYLIST_MODE = _env_with_runtime_default('EGRESS_DENYLIST_MODE', DEFAULT_ENV['EGRESS_DENYLIST_MODE'])
