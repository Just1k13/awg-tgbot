...
TEXT_DEFAULTS: dict[str, str] = {
    ...
    "payment_next_step": "Следующий шаг — откройте подключение и импортируйте его в Amnezia.",
    "payment_pending_followup": "Когда всё будет готово, нажмите «🔑 Получить подключение».",
